...
def light_confirm(self):
    current_CMD = str((self.Start_spinBox.value()))+"~"+str((self.End_spinBox.value()))+"~"+ str(self.R_spinBox.value()) + "~" + str(self.G_spinBox.value()) + "~" + str(self.B_spinBox.value())+ "~"+ str(self.W_spinBox.value())+ "~" + str(self.BRT_spinBox.value())+"\n4\n"
